...
#        print(" am in the data loader cod....data here is", data_dir)
...
#### modified by siri ####################
        ...
        mc_files = [i for i in mc_files if basename(i)[:9] in speakers] 
    ...
    def __getitem__(self, index):
        ...
        spk = join(basename(filename).split('_')[0] + '_' + basename(filename).split('_')[1])
#        print("spk is", spk)
        spk_idx = spk2idx[spk]
        mc = np.load(filename)
...
class TestDataset(object):
    """Dataset for testing."""
    def __init__(self, data_dir, wav_dir, src_spk='wavenet_c', trg_spk='wavenet_f'):
