...
spk2acc = {'c': 'US', #F
           ...
           'g': 'US',
           'h': 'US',} #M
speakers = ['wavenet_c', 'wavenet_e', 'wavenet_f', 'wavenet_g', 'wavenet_h']
...
if __name__ == '__main__':
    ...
    # Model configuration.
    parser.add_argument('--num_speakers', type=int, default=5, help='dimension of speaker labels')
    ...
    parser.add_argument('--src_spk', type=str, default='wavenet_c', help = 'target speaker.')
    parser.add_argument('--trg_spk', type=str, default='wavenet_f', help = 'target speaker.')
    ...
    parser.add_argument('--wav_dir', type=str, default="./data/Wavenet_voices/wav16")
